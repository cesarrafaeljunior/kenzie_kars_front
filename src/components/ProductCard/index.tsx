...
export const ProductCard = (advertData: any) => {
    ...
    return (
        <ListItem maxWidth={"320px"}>
            ...
            <Heading color={"grey.1"} marginTop={"15px"} fontSize={"16px"} fontWeight={"semibold"}>
            ...
            <Box gap={"8px"} marginTop={"20px"} alignItems={"center"} display={"flex"}>
                <Image
                    ...
                    borderRadius={"50%"}
                ></Image>
                <Text fontWeight={"medium"}>{advertData.advertData.adverter.adverterName}</Text>
            </Box>
            <Box marginTop={"15px"} display={"flex"} justifyContent={"space-between"}>
                ...
                <Text fontWeight={"bold"} fontSize={"16px"} color={"grey.1"} textDecoration={""}>
